...
from nlaugmenter.transformations.diverse_paraphrase.submod.submodopt import (
    SubmodularOpt,
)
from nlaugmenter.transformations.diverse_paraphrase.submod.submodular_funcs import (
    trigger_dips,
)
