...
class GeoNamesTransformation(SentenceOperation):
    ...
    def loadCities(self):
        ...
        with io.open(
            os.path.join(__location__, "cities5000.txt"),
            mode="r",
            encoding="utf8",
        ) as file:
            while True:
    ...
    def loadLocales(self):
        ...
        with io.open(
            os.path.join(__location__, "locales.txt"),
            mode="r",
            encoding="utf8",
        ) as file:
            first = True
    ...
    def loadCountries(self):
        ...
        with io.open(
            os.path.join(__location__, "countryInfo.txt"),
            mode="r",
            encoding="utf8",
        ) as file:
            while True:
    ...
    def pattern_countryWithPrimaryLanguage(
        self, start, final, data, textFeatures
    ):
        ...
        return [
            (
                start
                + ", a country speaking primarily the "
                + lang
                + " language"
                + final
            )
    ...
    def pattern_countryWithNumberOfLanguages(
        self, start, final, data, textFeatures
    ):
    ...
    def pattern_countryWithSpokenLanguages(
        self, start, final, data, textFeatures
    ):
        num_languages = len(data["languages"])
        if num_languages == 0:
    ...
    def generateCountry(self, feature, start, final, data, textFeatures):
        ...
        result += self.pattern_countryWithISO3(
            start, final, data, textFeatures
        )
        result += self.pattern_countryWithISOAndISO3(
            start, final, data, textFeatures
        )
        result += self.pattern_countryWithNeighbours(
            start, final, data, textFeatures
        )
    ...
    def pattern_cityWithPopulation(self, start, final, data, textFeatures):
        ...
        return [
            (start + ", a city with a population of " + population + final)
        ]

    def pattern_cityInCountryWithPopulation(
        self, start, final, data, textFeatures
    ):
        country = self.countries[data["country"]]["name"]
        population = "{:,}".format(int(data["population"]))
    ...
    def pattern_cityInContinent(self, start, final, data, textFeatures):
        continent = self.continents[
            self.countries[data["country"]]["continent"]
        ]
        if continent in textFeatures:
            return []
        return [(start + ", a city in " + continent + final)]

    def pattern_cityInContinentWithPopulation(
        self, start, final, data, textFeatures
    ):
        continent = self.continents[
            self.countries[data["country"]]["continent"]
    ...
    def pattern_cityCapitalOfCountry(
        self, city, start, final, data, textFeatures
    ):
    ...
    def generateCity(self, feature, start, final, data, textFeatures):
        ...
        result += self.pattern_cityWithPopulation(
            start, final, data, textFeatures
        )
        result += self.pattern_cityInCountryWithPopulation(
            start, final, data, textFeatures
        )
        result += self.pattern_cityInContinent(
            start, final, data, textFeatures
        )
