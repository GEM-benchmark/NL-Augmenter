...
class BertSentenceMaskFilling(SentenceOperation):
    ...
    def __init__(self,mask_model_name="bert-base-uncased",spacy_model_name="en_core_web_sm",n_mask_predictions = 3, seed=0):
    ...
    def generate(self, sentence: str) -> List[str]:
        ...
        for keyword in keywords:
            masked_sent = sentence.replace(keyword, self.mask_augmenter.tokenizer.mask_token, 1)
