...
disability_names = {
    "blind": "person or people with a visual impairment",
...
def different_ability(input, disability_names, nlp):
    text = input.lower()
...
class DifferentAbilityTransformation(SentenceOperation):
    ...
    def generate(self, sentence: str):
        return [different_ability(sentence, self.disability_names, self.nlp)]
