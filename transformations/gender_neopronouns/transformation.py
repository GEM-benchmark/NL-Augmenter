...
class GenderNeoPronouns(SentenceOperation):
    ...
    def __init__(self, swap_neopronoun: str = 'they', seed: int = 0, verbose: bool = False, max_outputs: int = 1) -> None:
        assert swap_neopronoun.capitalize() in TAGS, f"swap_neopronoun can only have value of {TAGS.keys()}"
    ...
    def generate(self, sentence: str) -> List[str]:
        ...
        for token in doc:
            ...
            if token.pos_ == 'PRON':
                ...
                neopronoun = neopronoun.capitalize() if token.is_title else neopronoun.lower()
