...
Processing speed of this Multilingual Lexicon Perturbation vs [Mixed Language Perturbation](https://github.com/gentaiscool/NL-Augmenter/tree/mixed_language_perturbation/transformations/mixed_language_perturbation) is 160x faster on the lexicon based one. The comparison of both perturbation are shown below:
<h1 align="center">
